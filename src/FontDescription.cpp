...
FontDescription::FontDescription() : pa_description(NULL) {
}

// pass i.e. "Hiragino Maru Gothic ProN 15"
void FontDescription::createFromString(std::string sFontSpec) {
	createFromString(sFontSpec.c_str());
}
void FontDescription::createFromString(const char *pFontSpec) {
 ...
 * - PANGO_STYLE_ITALIC
 */
void FontDescription::setStyle(PangoStyle nStyle) {
 ...
 */
void FontDescription::setVariant(PangoVariant nVariant) {
	if (pa_description == NULL)
		;
	return;
 ...
 */
void FontDescription::setWeight(PangoWeight nWeight) {
	if (pa_description == NULL)
		;
	return;
 ...
 */
void FontDescription::setStretch(PangoStretch nStretch) {
	if (pa_description == NULL)
		;
	return;
